...
<head>
    <met#aeb3b8et="utf-8">
        <title>Shuvo Khan CV Resume </title>
        <meta content="width=device-width, initial-scale=1.0" name="viewport">
        <meta content="Free Website Template" name="keywords">
        <meta content="Free Website Template" name="description">

        <!-- Favicon -->
        <link href="img/port.png" rel="icon">
        ...
        <div class="row g-5">
            <div class="col-lg-4 sticky-lg-top vh-100">
                <div class="d-flex flex-column h-100 text-center overflow-auto shadow">
                    ...
                    <h1 class="text-primary mt-2"> <i class="fa-duotone fa-aperture"></i>Shuvo Khan</h1>
                    <div class="mb-4" style="height: 22px;">
                        <h4 class="typed-text-output d-inline-block text-light"></h4>
                        <div class="typed-text d-none">Leaener, Author , Web Developer, Front End Developer, Apps Designer, Apps Developer</div>
                    </div>
                    <div class="d-flex justify-content-center mt-auto mb-3">
                        <a class="btn btn-secondary btn-square mx-1" href="https://twitter.com/Agonyshuvo" target="blank"><i class="fab fa-twitter" style="color: #1C9BEF;"></i></a>
                        <a class="btn btn-secondary btn-square mx-1" href="https://twitter.com/Agonysuvo" target="blank"><i class="fab fa-facebook-f" style="color: #0B86EE;"></i></a>
                        <a class="btn btn-secondary btn-square mx-1" href="https://www.linkedin.com/in/agony-shuvo/" target="blank"><i class="fab fa-linkedin-in" style="color:#0B65C2"></i></a>
                        <a class="btn btn-secondary btn-square mx-1" href="https://www.instagram.com/agony_shuvo/" target="blank"><i class="fab fa-instagram" style="color:#F4513F;"></i></a>
                    </div>
            ...
            <div class="col-lg-8">
                ...
                <section class="py-5 border-bottom wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-6 py-1">
                            <span class="fw-medium text-primary">Birthday :</span> 15 Novembar , 1997
                        </div>
                        <div class="col-sm-6 py-1">
                            <span class="fw-medium text-primary">Degree :</span> The Bachelor Degree in CSE
                        </div>
                        <div class="col-sm-6 py-1">
                            <span class="fw-medium text-primary">Experience :</span> 1 Years
                        </div>
                        <div class="col-sm-6 py-1">
                            <span class="fw-medium text-primary">Phone :</span> +880 1612 291229
                        </div>
                        <div class="col-sm-6 py-1">
                            <span class="fw-medium text-primary">Email :</span> agonysuvo@gmail.com
                        </div>
                        <div class="col-sm-6 py-1">
                            <span class="fw-medium text-primary">Address :</span> Khilkahte, Dhaka, Bangladesh
                        </div>
                        <!-- <div class="col-sm-6 py-1">
                ...
                <section class="py-5 wow fadeInUp" data-wow-delay="0.1s">
                    <h1 class="title pb-3 mb-5"> Work</h1>
                    <div class="border-start border-2 border-light pt-2 ps-5">
                        ...
                        <div class="position-relative mb-4">
                            ...
                            <div class="timeline-block"> <a href="https://www.nsuer.top/" target="blank" style="text-decoration: none;color:white;">
                                    <h5 class="mb-1"> Nsuer </h5>

                                </a>
                                <p class="mb-2">Author & Software Engineer <br> <small>2021 - present</small></p>
                            ...
                            <div class="position-relative mb-4">
                                ...
                                <a href="https://www.bcspoint.net/" target="blank" style="text-decoration: none;color:white; ">
                                    <h5 class="mb-1">Bcs Point</h5>
                                </a>
                                <p class="mb-2">Author & Software Engineer <br> <small>2020 - present</small></p>
                                <!-- <p>Tempor eos dolore amet tempor dolor tempor. Dolore ea magna sit amet dolor eirmod. Eos ipsum est tempor dolor. Clita lorem kasd sed ea lorem diam ea lorem eirmod duo sit ipsum stet lorem diam</p> -->
                            </div>
                            ...
                            <div class="position-relative mb-4">
                                <span class="bi bi-arrow-right fs-4 text-light position-absolute" style="top: -5px; left: -50px;"></span>
                                <h5 class="mb-1"> Choching</h5>
                                <p class="mb-2">Tutor <br>
                                    <small>2020 - 2021 [Online] <br>
                                        2018- 2020
                                    </small>
                                </p>
                                <!-- <p>Tempor eos dolore amet tempor dolor tempor. Dolore ea magna sit amet dolor eirmod. Eos ipsum est tempor dolor. Clita lorem kasd sed ea lorem diam ea lorem eirmod duo sit ipsum stet lorem diam</p> -->
                ...
                <section class="py-5 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="border-start border-2 border-light pt-2 ps-5">
                        <div class="position-relative mb-4">
                            <span class="bi bi-arrow-right fs-4 text-light position-absolute" style="top: -5px; left: -50px;"></span>
                            <h5 class="mb-1">North South University</h5>
                            <p class="mb-2">Bsc in CSE <br> <small>2017 - present</small></p>
                            <!-- <p>Tempor eos dolore amet tempor dolor tempor. Dolore ea magna sit amet dolor eirmod. Eos ipsum est tempor dolor. Clita lorem kasd sed ea lorem diam ea lorem eirmod duo sit ipsum stet lorem diam</p> -->
                        </div>
                        <br>
                        <div class="position-relative mb-4">
                            <span class="bi bi-arrow-right fs-4 text-light position-absolute" style="top: -5px; left: -50px;"></span>
                            <h5 class="mb-1">Police Lines School & College
                            </h5>
                            <p class="mb-2"> Science <br>
                        ...
                        <div class="position-relative mb-4">
                            <span class="bi bi-arrow-right fs-4 text-light position-absolute" style="top: -5px; left: -50px;"></span>
                            <h5 class="mb-1">Chandaikona M.L. High School</h5>
                            <p class="mb-2">Science <br> <small>2008 - 2013</small></p>
                            <!-- <p>Tempor eos dolore amet tempor dolor tempor. Dolore ea magna sit amet dolor eirmod. Eos ipsum est tempor dolor. Clita lorem kasd sed ea lorem diam ea lorem eirmod duo sit ipsum stet lorem diam</p> -->
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="skill mb-4">
                                ...
                                <div class="progress">
                                    <div class="progress-bar bg-info" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                            <div class="skill mb-4">
                                <div class="d-flex justify-content-between">
                                ...
                                <div class="progress">
                                    <div class="progress-bar " role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="background: chartreuse;"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="skill mb-4">
                                ...
                                <div class="progress">
                                    <div class="progress-bar " role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="background: chartreuse;"></div>
                                </div>
                            </div>
                            <div class="skill mb-4">
                                <div class="d-flex justify-content-between">
                            ...
                            <div class="skill mb-4">
                                <div class="d-flex justify-content-between">
                                    <p class="mb-2">Android Studio</p>
                                    <p class="mb-2">25%</p>
                                </div>
                                <div class="progress">
                                    <div class="progress-bar " role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="background: cornflowerblue;"></div>
                                </div>
                            </div>
                            <div class="skill mb-4">
                                <div class="d-flex justify-content-between">
                                    <p class="mb-2">Xcode</p>
                                    <p class="mb-2">5%</p>
                                </div>
                                <div class="progress">
                                    <div class="progress-bar bg-warning" role="progressbar" aria-valuenow="5" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>

                            <div class="skill mb-4">
                                <div class="d-flex justify-content-between">
                                    <p class="mb-2">Final Cut Pro</p>
                                    <p class="mb-2">70%</p>
                                </div>
                                <div class="progress">
                                    <div class="progress-bar " role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="background: orangered;;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Portfolio Start -->
                <section class="py-5 border-bottom wow fadeInUp" data-wow-delay="0.1s">
                    <h1 class="title pb-3 mb-5">Interest</h1>
                    <div class="row">
                        <div class="col-12">
                            <div class="row">
                                <div class="col-12 text-center mb-2">
                                    <ul class="list-inline mb-4" id="portfolio-flters">
                                        ...
                                        <li class="btn btn-secondary" data-filter=".sixth"><i class=" fa-solid fa-calculator me-2"></i>Math</li>
                                        <li class="btn btn-secondary" data-filter=".seventh"><i class="fa-solid fa-book-journal-whills me-2"></i>History</li>
                                        <li class="btn btn-secondary" data-filter=".second"><i class="fa fa-laptop-code me-2"></i>Design</li>
                                        <li class="btn btn-secondary" data-filter=".first"><i class="fa-solid fa-photo-film me-2"></i>Photography</li>
                                        <li class="btn btn-secondary" data-filter=".forth"><i class=" fa-solid fa-person-chalkboard me-2"></i> Teaching </li>
                                        <li class="btn btn-secondary" data-filter=".fifth"><i class=" fas fa-user-edit me-2"></i> Blog </li>
                            ...
                            <div class="row portfolio-container">
                                ...
                                <!--  <div class="col-md-6 mb-4 portfolio-item third">
                                 ...
                                 <div class="col-md-6 mb-4 portfolio-item fourth">
                                    <div class="position-relative overflow-hidden mb-2">
                                ...
                                <!-- <div class="col-md-6 mb-4 portfolio-item fifth">
                                    <div class="position-relative overflow-hidden mb-2">
                                        <img class="img-fluid w-100" src="img/profile.jpg" alt="">
                                        <div class="portfolio-btn d-flex align-items-center justify-content-center">
                                            <a href="img/portfolio-4.jpg" data-lightbox="portfolio">
                                                <i class="bi bi-plus text-light"></i>
                                            </a>
                ...
                <section class="wow fadeIn" data-wow-delay="0.1s">
                    <div class="bg-secondary text-light text-center p-5">
                        ...
                        <p class="m-0">&copy; All Rights Reserved. Designed by <a href="https://htmlcodex.com">Mr Khan</a></p>
                    </div>
                </section>
                <!-- Footer End -->
            </div>
